	...
	<div class="container-fluid rezgo-container rezgo-itinerary-container">
		...
		<div class="flex-row justify-between col-reverse itinerary-header-container">
			<div class="flex-col">
				...
				<button class="rezgo-print-itinerary" onclick="window.open('<?php echo esc_js($site->base); ?>/itinerary/<?php echo esc_js($site->encode($trans_num)); ?>/print', '_blank'); return false;"><i class="far fa-print"></i>&nbsp;&nbsp;Print Itinerary</button>
			</div>
														...
														<div class="rezgo-map" id="rezgo-receipt-map">
															...
															<div class="rezgo-map-location rezgo-map-shadow">
																<?php if($location_name[$booking->com] != '') { ?>
																	<div class="rezgo-map-icon pull-left"><i class="far fa-map-marker"></i></div> <?php echo esc_html($location_name[$booking->com]); ?>
																	<div class="rezgo-map-hr"></div>
																<?php } ?>

																<?php if($location_address[$booking->com] != '') { ?>
																	<div class="rezgo-map-icon pull-left"><i class="far fa-location-arrow"></i></div> <?php echo esc_html($location_address[$booking->com]); ?>
																	<div class="rezgo-map-hr"></div>
																<?php } else { ?>
																	<div class="rezgo-map-icon pull-left"><i class="far fa-location-arrow"></i></div> <?php echo esc_html($city[$booking->com].' '.$state[$booking->com].' '.$site->countryName($country[$booking->com])); ?>
																	<div class="rezgo-map-hr"></div>
																<?php } ?>

																<div class="rezgo-map-icon pull-left"><i class="far fa-globe"></i></div> <?php echo round((float) $lat[$booking->com], 3); ?>, <?php echo esc_html(round((float) $lon[$booking->com], 3)); ?>
															</div>
														</div>
													</span>
												</div>
